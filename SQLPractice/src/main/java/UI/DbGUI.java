...
public class DbGUI {
	...
	public static void main(String[] args) {
		...
		try {
			connection = DriverManager.getConnection("jdbc:mysql://localhost/?user=java&password=password");
	...
	private static class CategoryPage extends JPanel {
		...
		public CategoryPage() {
			...
			categoryInputBtn.addActionListener(new ActionListener() {
				...
				@Override
				public void actionPerformed(ActionEvent e) {
					JOptionPane.showMessageDialog(CategoryPage.this, "category added", "info",
			...
			deleteCategoryBtn.addActionListener(new ActionListener() {
				...
				@Override
				public void actionPerformed(ActionEvent e) {
					JOptionPane.showMessageDialog(CategoryPage.this, "category removed", "info",
							JOptionPane.INFORMATION_MESSAGE);
	...
	private static class DisplayPage extends JPanel {
		...
		public DisplayPage() {
			...
			String[][] data = { { "id 1", "item 1", "description 1" }, { "id 1", "item 2", "description 2" } };
			...
			deleteItemBtn.addActionListener(new ActionListener() {
				...
				@Override
				public void actionPerformed(ActionEvent e) {
					JOptionPane.showMessageDialog(DisplayPage.this, "item removed", "info",
							JOptionPane.INFORMATION_MESSAGE);
